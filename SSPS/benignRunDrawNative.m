data=xlsread('A-BenignRuntimeforSPSS.xlsx',4,'A2:G1361');
failure_rate=data(:,1);
minsdk=data(:,2);
api=data(:,3);
year=data(:,4);
...
title('Benign native error induced failed execution percentage distribution among different API level');
