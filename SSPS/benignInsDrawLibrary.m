data=xlsread('A-BenignInstallforSPSS.xlsx',3,'A2:G1697');
failure_rate=data(:,1);
minsdk=data(:,2);
api=data(:,3);
year=data(:,4);
...
title('Benign missing shared library induced failed installation percentage distribution among different API level');
