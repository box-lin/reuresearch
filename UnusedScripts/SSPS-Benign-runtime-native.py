...
if __name__ == "__main__":
    ...
    wb.save('Data/RunSPSS-2018-2019-native_benign.xlsx')
    print("Result write into Data/RunSPSS-2018-2019-native_benign.xlsx completed!")
    ...
    print('Native Error apk: ', librarycnt)