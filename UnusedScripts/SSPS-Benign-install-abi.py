...
ABI = 'INSTALL_FAILED_NO_MATCHING_ABIS'
...
if __name__ == "__main__":
    ...
    wb.save('Data/InstallSPSS-2018-2019-abi_benign.xlsx')
    print("Result write into Data/InstallSPSS-2018-2019-abi_benign.xlsx completed!")
